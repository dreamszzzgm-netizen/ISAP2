...
_KNOWLEDGE_BASE: dict[str, dict] = {
    ...
    "агзс": {
        ...
        "hazards": [
            ...
            "разрушение оборудования под давлением",
            "термическое воздействие",
        ],
        "recommended_scenarios": [
            "разгерметизация резервуара СУГ",
            "разгерметизация трубопровода СУГ",
            "утечка СУГ при сливе из автоцистерны",
            "пожар в зоне заправочной колонки",
            "образование газовоздушного облака с последующим воспламенением",
        ...
        "required_appendices": [
            "схема расположения АГЗС",
            "схема зон возможного воздействия",
            "схема оповещения",
            "перечень сил и средств",
            "документы ПАСФ / АСФ",
            "сведения о страховании",
