...
from src.application.engines.blocks import Block, ParagraphBlock
    ...
    def _generate_fallback(self, section_id: str, context: DocumentContext) -> list[Block]:
        ...
        if section_id == "introduction":
            return [
                ...
                ParagraphBlock(text=(
                    "ПМЛА разработан на основании:\n"
                    "- Федерального закона от 21.07.1997 № 116-ФЗ «О промышленной безопасности "
                    "опасных производственных объектов»;\n"
                    "- Постановления Правительства РФ от 15.09.2020 № 1437 «О федеральном "
                    "государственном надзоре в области промышленной безопасности»;\n"
                    "- Приказа Ростехнадзора от 11.12.2020 № 472 «Об утверждении Федеральных "
                    "норм и правил в области промышленной безопасности «Требования к разработке "
                    "планов мероприятий по ликвидации аварий на опасных производственных "
                    "объектах»»;\n"
                    "- Приказа Ростехнадзора от 15.12.2020 № 531 «Об утверждении Федеральных "
                    "норм и правил в области промышленной безопасности «Порядок расследования "
                    "и учёта несчастных случаев на производстве»»."
                )),
                ParagraphBlock(text=(
                    "Целью разработки ПМЛА является обеспечение готовности организации к "
                    "локализации и ликвидации последствий аварий на опасном производственном "
                    "объекте, минимизация их масштаба и последствий."
                )),
                ParagraphBlock(text=(
                    "Задачами ПМЛА являются:\n"
                    "- определение сценариев наиболее вероятных аварий;\n"
                    "- расчёт необходимых сил и средств для ликвидации аварий;\n"
                    "- разработка мероприятий по локализации и ликвидации последствий аварий;\n"
                    "- определение порядка оповещения и взаимодействия служб."
                )),
                ParagraphBlock(text=(
