"""Полная генерация DOCX со всеми обогащёнными справочниками разделами."""
import asyncio
import sys
sys.path.insert(0, ".")
...
ctx = DocumentContext(
    ...
    persons=[
        {"full_name": "Сидоров А.В.", "position": "Председатель комиссии", "role": "chairman", "phone": "+7-999-111-11-11"},
        {"full_name": "Козлов Д.М.", "position": "Диспетчер", "role": "dispatcher", "phone": "+7-999-222-22-22"},
        {"full_name": "Петров И.С.", "position": "Начальник смены", "role": "shift_supervisor", "phone": "+7-999-333-33-33"},
    ],
    year=2026,
)
...
output_path = "test_full_output.docx"
